...
#
# Created by fc write_sdc on Thu May 28 17:14:36 2026
#
################################################################################
...
# /home/user18/Projects/Flash_controller/FYP_latest/source/3_dual_mode/outputs/dual_mode_controller.sdc, \
#   line 54
create_clock -name HCLK -period 20 -waveform {0 10} [get_ports {HCLK}]
# /home/user18/Projects/Flash_controller/FYP_latest/source/3_dual_mode/outputs/dual_mode_controller.sdc, \
#   line 61
create_generated_clock -name QSPI_CLK -divide_by 1 -source [get_ports {HCLK}] \
    [get_ports {qspi_clk}]
set_propagated_clock [get_clocks {HCLK}]
set_propagated_clock [get_clocks {QSPI_CLK}]
# /home/user18/Projects/Flash_controller/FYP_latest/source/3_dual_mode/outputs/dual_mode_controller.sdc, \
#   line 440
...
# -origin useful_skew
set_clock_latency 0.519458 [get_clocks {HCLK}]

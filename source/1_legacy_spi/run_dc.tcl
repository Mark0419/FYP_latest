# ==========================================================================
# Design Compiler synthesis script: Legacy SPI controller
# Run from: source/1_legacy_spi
# ==========================================================================

set DESIGN_NAME "legacy_spi_controller"
set TOP_MODULE  "ahb_spi_legacy"
set RTL_FILES   [list \
    ahb_spi_wrapper.sv \
    spi_fsm.sv \
]
...
set_app_var target_library "$SAED_PATH/lib/stdcell_rvt/db_nldm/saed14rvt_tt0p8v25c.db"
...
write_file -format verilog -hierarchy -output outputs/${DESIGN_NAME}_mapped.v

...
# SPI clock is generated by the controller and forwarded to the flash pins.
...
set_clock_uncertainty -setup 0.500 [get_clocks SPI_CLK]
set_clock_uncertainty -hold  0.100 [get_clocks SPI_CLK]
...
set SPI_OUT_PORTS [get_ports {spi_cs_n spi_mosi}]

set_output_delay -max 8.000 -clock HCLK $AHB_OUT_PORTS
set_output_delay -min 1.000 -clock HCLK $AHB_OUT_PORTS

# spi_clk is constrained as a generated clock, not as a data output.

...
ARCHIVE_OBJS=
ARCHIVE_OBJS += _218160_archive_1.so
_218160_archive_1.so : archive.5/_218160_archive_1.a
	@$(AR) -s $<
	@$(PIC_LD) -shared  -Bsymbolic $(LD_NORELAX_FLAG)  -o .//../simv.daidir//_218160_archive_1.so --whole-archive $< --no-whole-archive
	@rm -f $@
	@ln -sf .//../simv.daidir//_218160_archive_1.so $@
